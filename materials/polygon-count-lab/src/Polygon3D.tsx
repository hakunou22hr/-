...
type Props={n:number,mode:Mode,current:Pair|Triple|null,activePair:Pair|null,activeTriple:Triple|null,showAll:boolean,completedDiagonalKeys:Set<string>,manual:boolean,base:Pair|null,picked:number[],tilt:boolean,cameraReset:number,onVertex:(x:number)=>void,onEdge:(x:number)=>void}
