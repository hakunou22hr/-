...
export const INEQUALITIES:Inequality[]=[
 ...
 {id:'top',label:'3x + y ≦ 9',boundary:'3x + y = 9',a:3,b:1,c:9,color:'#e07a17'},
...
export function extrema(vertices:Point[]){if(!vertices.length)return null;return{min:vertices.reduce((a,b)=>2*a.x+a.y<=2*b.x+b.y?a:b),max:vertices.reduce((a,b)=>2*a.x+a.y>=2*b.x+b.y?a:b)}}
