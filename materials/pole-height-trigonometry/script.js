...
const lessons = {
  acd: { no:'01', title:'△ACD ― 60° の面', question:'どうやって h を求める？', note:'直角三角形で「高さ」と「底辺」を直接つなぐので tan が使えます。', angle:'60°', base:'AC', points:['A','C','D'], steps:['tan 60° = h / AC','tan 60° = √3 より','√3 = h / AC','<strong>AC = h / √3</strong>','<span class="conclusion">ここでは AC を h で表すことができる。</span>'] },
  bcd: { no:'02', title:'△BCD ― 45° の面', question:'この面ではどんな式が立てられる？', note:'ここでも、仰角の向かいが h、隣が BC。tan がぴったりです。', angle:'45°', base:'BC', points:['B','C','D'], steps:['tan 45° = h / BC','tan 45° = 1 より','1 = h / BC','<strong>BC = h</strong>','<span class="conclusion">ここでは BC を h で表すことができる。</span>'] },
  abc: { no:'03', title:'△ABC ― 地面の面', question:'この三角形で h を求めるには、どの公式？', note:'2辺 AC、BC とその間の角30°、向かいの辺 AB が登場。余弦定理を使います。', ground:true, steps:['AB² = AC² + BC² − 2・AC・BC・cos ∠ACB','6² = (h/√3)² + h² − 2・(h/√3)・h・cos 30°','cos 30° = √3/2 を代入','36 = h²/3 + h² − 2・(h²/√3)・(√3/2)','36 = h²/3 + h² − h²','36 = h²/3','h² = 108','<strong>h = 6√3</strong>','<span class="answer glow">答え：CD = h = 6√3 m</span>'] }
}

const formulas = {
  sin:{title:'sin（正弦）',shape:'sin θ = 対辺 / 斜辺',meaning:'高さに関係する比を表しやすい公式です。',when:'直角三角形で、斜辺と向かいの辺を結びたいとき。',use:'この問題では斜辺が不要なので、tan の方が直接的です。'},
  cos:{title:'cos（余弦）',shape:'cos θ = 隣辺 / 斜辺',meaning:'角の隣にある横の長さと斜辺の比です。',when:'直角三角形で、隣辺と斜辺を結びたいとき。',use:'補助的には使えますが、h を出すには tan が自然です。'},
  tan:{title:'tan（正接）',shape:'tan θ = 対辺 / 隣辺',meaning:'「高さ ÷ 底辺」の比を表します。',when:'高さと水平距離を直接結びたいとき。',use:'◎ △ACD と △BCD で、h と AC、BC を結びます。'},
  sine:{title:'正弦定理',shape:'a / sin A = b / sin B = c / sin C',meaning:'辺と、その向かいの角との関係を表します。',when:'向かい合う辺と角の組が分かるとき。',use:'△ABC でも検討できますが、既知の情報からは余弦定理が自然です。'},
